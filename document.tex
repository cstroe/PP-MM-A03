...
\begin{eqnarray*}
T_p &=& T_{{comp}} + T_{{comm}} \\
&=& t_{{mult}} \cdot n^3 + t_s \cdot (2 \cdot \log{p} + 3/2 \cdot \sqrt{p}) + t_w \cdot (n^2/p) \cdot (2p-1) \\
&=& O(n^3 + \log{p} + \sqrt{p} + n^2 \cdot (2p-1)/p) \\
&=& O(n^3 + \sqrt{p})
\end{eqnarray*}
...
\begin{eqnarray*}
T_{{comp}} &=& O(t_{{mult}} \cdot p \cdot \sqrt{p} \cdot (n/\sqrt{p})^{2.807}) \\
&=& O(t_{{mult}} \cdot p^{3/2} \cdot (n/\sqrt{p})^{2.807}) \\
&=& O(t_{{mult}} \cdot n^{2.807} \cdot p^{3/2} \cdot  p^{-2.807/2}) \\
&=& O(t_{{mult}} \cdot n^{2.807} \cdot  p^{(3-2.807)/2}) \\
&=& O(t_{{mult}} \cdot n^{2.807} \cdot  p^{0.096})
\end{eqnarray*}
