...
%&=& \frac{pn^3}{ O(p\sqrt{p} + n^2 \cdot (2p+n)) } \\
%&=& O(\frac{pn^3}{ n^3 + 2n^2p + p\sqrt{p} }) \\
%&=& O(\frac{1}{ \frac{ n^3 + p\sqrt{p} + 2n^2p }{pn^3} }) \\
%&=& O(\frac{1}{ 1/p + 2/n + \frac{ \sqrt{p} }{n^3} }) \\
%&=& O(\frac{n^3 + (p-1)n^3}{ n^3 + 2n^2p + p\sqrt{p} }) \\
%&=& O(\frac{p}{ 1 + 2p/n + p\sqrt{p}/n^3 })
